      ...
      <ul className="db-nav-list">
        ...
        <li className="db-nav-item db-nav-dropdown" onClick={() => handleToggle("event")}>
          ...
          <ul className={`dropdown-list ${openDropdown === "event" ? "show" : ""}`}>
            ...
            <li><Link to="/pendingevent">Pending Events</Link></li>
        ...
        <li className="db-nav-item db-nav-dropdown" onClick={() => handleToggle("job")}>
          ...
          <ul className={`dropdown-list ${openDropdown === "job" ? "show" : ""}`}>
            ...
            <li><Link to="/pendingpost">Pending Posts</Link></li>
            <li><Link to="/myevent">My Posts</Link></li>
          </ul>
        </li>

        <li className="db-nav-item">
          <Link to="/News" className="db-nav-link">
            <GoProjectRoadmap className="db-nav-icon" />
            <span>News</span>
          </Link>
        </li>
        ...
        <li className="db-nav-item">
          <Link to="/chatapp" className="db-nav-link">
            <AiOutlineMessage className="db-nav-icon" />
            <span>Message</span>
          </Link>
        </li>
        ...
        <li className="db-nav-item">
          <Link to="/adminprofile" className="db-nav-link">
        ...
        <li className="db-nav-item db-nav-dropdown" onClick={() => handleToggle("settings")}>
          ...
          <ul className={`dropdown-list ${openDropdown === "settings" ? "show" : ""}`}>
            ...
            <li><Link to="/settings/batchsetting">Batch Setting</Link></li>
            <li><Link to="/settings/departmentsetting">Department Setting</Link></li>
            <li><Link to="/settings/passingyearsetting">Passing Year Setting</Link></li>
          </ul>
        </li>

...
import AdminEditEvent from '../AdminEditEvent'; // Popup
// import "../../../styles/Event/MyEvent.css";
import "../../../../styles/AdminFlow/AdminEvent/AdminMyEvent.css"
...
const AdminMyEvent = () => {
  ...
  return (
    <>
      ...
      {/* Show Edit Popup */}
      {showEditPopup && <AdminEditEvent onClose={handleClosePopup} />}
    </>
  );
};

export default AdminMyEvent;
